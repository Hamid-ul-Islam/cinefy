...
export const startRequest = createAsyncThunk(
    'socrates/startRequest',
    async (args: { socData: SocratesData }, { getState, requestId }) => {
...
const socratesSlice = createSlice({
    name: 'socrates',
    initialState: {
        token: '',
        status: 'idle',
...
export default socratesSlice.reducer;
